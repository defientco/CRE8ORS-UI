...
const getImplementationAddress = async (proxyAddress, chainId = CHAIN_ID) => {
  const data = await getStorageAt(proxyAddress, ERC1967_IMPLEMENTATION_SLOT, "latest", chainId)
